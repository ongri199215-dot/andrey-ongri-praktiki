...
`;
css += `.practice-detail-card{width:min(360px,calc(100% - 40px));display:flex;min-height:0;flex-direction:column;gap:16px;padding:clamp(28px,5vw,58px) 0}.practice-detail-card .cover{width:100%}.actions-compact{width:100%;margin:0;gap:8px}.actions-compact a{min-width:0;padding:11px 14px;border-radius:999px;font-size:9px;letter-spacing:.08em}@media(max-width:650px){.practice-detail-card{width:min(360px,calc(100% - 36px));display:flex;padding:20px 0}.practice-detail-card .cover{max-width:none}.actions-compact a{padding:11px 8px}}`;
