...
const detail = page({
  body: `<main class="showcase"><header class="topbar detail-topbar"><span>ПРАКТИКИ ОТ АНДРЕЯ ОНГРИ</span><a href="../../">← ВСЕ ПРАКТИКИ</a></header><section class="detail-card"><a class="cover" href="read/"><img src="../../${cover}" alt="Первая страница гайда ${title}"></a><div class="practice-info"><p class="eyebrow">БЕСПЛАТНЫЙ PDF · 12 СТРАНИЦ</p><h1>${title}</h1><p>${description}</p><p class="contents">Внутри: просьбы близких, давление, работа, деньги и право передумать.</p><div class="actions"><a href="read/">Смотреть гайд</a><a class="download-guide" href="../../${guide}" download>Скачать</a></div></div></section></main>`,
});
